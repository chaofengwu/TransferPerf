...
train_domain_num = input_idx // num_folds
fold_num = input_idx % num_folds
...
for model_type in model_types:
    for cur_seed in seed_list:
        # if count == cur_idx:
        print(train_domain_num, model_type, cur_seed, experiment_type, X_train.shape, X_test.shape)
        cur_model = ML_models(model_type=model_type, random_seed=cur_seed)
        cur_model.fit(X_train, y_train)
        error = cur_model.get_error(X_train, y_train)
        res['seed'] = cur_seed
